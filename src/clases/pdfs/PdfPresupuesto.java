...
public class PdfPresupuesto {
    ...
    public PdfPresupuesto(String destinoString, String nombreCliente, String nombreUsuario, ArrayList<ArrayList> datosAgregados, Connection connection,String presuofactura) {
        ...
        Image logo = null;
        try {
            if (this.destinoString.equals("")) {

                destino = destino + File.separator + "pdf" + (Instant.now()).toEpochMilli() + ".pdf";
                this.writer = new PdfWriter(destino);
            } else {
                this.writer = new PdfWriter(this.destinoString);
            }
            ...
            Table tablaprin = new Table(new float[]{48, 26, 26});
            tablaprin.addCell(getCell(logo, TextAlignment.LEFT))
                    .addCell(getCell(presuofactura, TextAlignment.CENTER))
    ...
    public PdfPresupuesto(String destinoString, String nombreCliente, String facturacionString, String nombreUsuario, ArrayList<ArrayList> datosAgregados, Connection connection,String presuofactura) {
        destino = ESTACARPETA + File.separator + "Pdfs";
        this.destinoString = destinoString;
    ...
    private Cell getCell(String s, TextAlignment alignment) {
