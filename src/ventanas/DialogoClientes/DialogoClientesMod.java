 ...
 * @author Wiku
 */
public class DialogoClientesMod extends javax.swing.JDialog {
    String dato1;
    String dato2;
    String dato3;
    String dato4;
    ...
    public DialogoClientesMod(javax.swing.JDialog parent, boolean modal, Connection connection,String dato1,String dato2,String dato3,String dato4,String dato5,String dato6,String dato8,String dato9,String dato10) {
        super(parent, modal);
        initComponents();
        ...
        this.dato9=dato9;
        this.dato10=dato10;
        jTextField1.setText(dato1);
        jTextField2.setText(dato2);
        jTextField3.setText(dato3);
        jTextField4.setText(dato4);
        jTextField5.setText(dato5);
        jTextField6.setText(dato6);
        jTextField7.setText(dato8);
        jTextField9.setText(dato9);
        jTextField8.setText(dato10);
        numeroentrada=1;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if(!jTextField1.getText().equals(dati1orig)){
                int input=JOptionPane.showConfirmDialog(null,"Aviso, vas a cambiar la clave principal \"NombreCliente\", Estas seguro?");
                if(input==1 || input==2){
                    dato1=dati1orig;
                    //testgit
                }else{
            ...
            String sql = "Update Clientes set nombreCliente='"+jTextField1.getText()
            + "',direccion='"+jTextField2.getText()
            + "',pais='"+jTextField3.getText()
            + "',mail='"+jTextField4.getText()
            + "',tel='"+jTextField5.getText()
            + "',ident='"+jTextField6.getText()
            + "',poblacion='"+jTextField7.getText()
            + "',provincia='"+jTextField9.getText()
            + "',cp='"+jTextField8.getText()
            +"' where nombreCliente='"+dati1orig+"'" ;
